 ...
 */
final class Version20251104175457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catagories ADD CONSTRAINT FK_CEBC627BA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catagories DROP FOREIGN KEY FK_CEBC627BA76ED395');
        $this->addSql('ALTER TABLE catagories ADD CONSTRAINT FK_CEBC627BA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE transactions DROP FOREIGN KEY FK_EAA81A4CA76ED395');
